...
dropdownDistribution.addItem(QIcon("Images/ubuntuicon.jpg"), 'Linux Ubuntu')
...
selectFiles.setFixedSize(115, 30)
...
def Start():
    if checkbox.isChecked():
        if dropdownDistribution.currentIndex() == 0:
            ...
            subprocess.run(["powershell", "-File", "ubuntuisodownload.ps1"], capture_output=True, text=True)
