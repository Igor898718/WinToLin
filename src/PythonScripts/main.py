...
def Start():
    if checkbox.isChecked():
        ...
        subprocess.run(["powershell", "-File", "PowerShellScripts/createpartition.ps1"], capture_output=True, text=True)
        os.rename(".", "W://")
        if dropdownDistribution.currentIndex() == 0:
            subprocess.run(["powershell", "-File", "PowerShellScripts/mintisodownload.ps1"], capture_output=True, text=True)
        elif dropdownDistribution.currentIndex() == 1:
            subprocess.run(["powershell", "-File", "PowerShellScripts/archisodownload.ps1"], capture_output=True, text=True)
        elif dropdownDistribution.currentIndex() == 2:
            subprocess.run(["powershell", "-File", "PowerShellScripts/debianisodownload.ps1"], capture_output=True, text=True)
        elif dropdownDistribution.currentIndex() == 3:
            subprocess.run(["powershell", "-File", "PowerShellScripts/fedoraisodownload.ps1"], capture_output=True, text=True)
        elif dropdownDistribution.currentIndex() == 4:
            subprocess.run(["powershell", "-File", "PowerShellScripts/manjaroisodownload.ps1"], capture_output=True, text=True)
        elif dropdownDistribution.currentIndex() == 5:
            subprocess.run(["powershell", "-File", "PowerShellScripts/opensuseisodownload.ps1"], capture_output=True, text=True)
        elif dropdownDistribution.currentIndex() == 6:
            subprocess.run(["powershell", "-File", "PowerShellScripts/kaliisodownload.ps1"], capture_output=True, text=True)
        elif dropdownDistribution.currentIndex() == 7:
            subprocess.run(["powershell", "-File", "PowerShellScripts/wubuntuisodownload.ps1"], capture_output=True, text=True)
